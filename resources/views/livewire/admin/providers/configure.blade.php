<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <form wire:submit="save" class="space-y-4">
                ...
                <flux:field>
                    ...
                    <textarea
                        wire:model="metadata"
                        rows="8"
                        class="w-full border border-zinc-200 dark:border-zinc-700 rounded-lg p-3 text-sm font-mono bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-200"
        ...
        <flux:card>
            ...
            <div class="space-y-3">
                <div>
                    <span class="text-sm font-medium text-zinc-600 dark:text-zinc-300">Knowledge Source</span>
                    <p>{{ $sourceName ?? 'N/A' }}</p>
                </div>
                <div>
                    <span class="text-sm font-medium text-zinc-600 dark:text-zinc-300">Current Status</span>
                    <p>
                ...
                <div>
                    <span class="text-sm font-medium text-zinc-600 dark:text-zinc-300">Last Synced</span>
                    <p>{{ $lastSyncedAt ?? 'Never' }}</p>
                </div>
                @if ($errorMessage)
                <div>
                    <span class="text-sm font-medium text-zinc-600 dark:text-zinc-300">Error</span>
                    <p class="text-red-600 dark:text-red-400">{{ $errorMessage }}</p>
                </div>
                @endif
                <div>
                    <span class="text-sm font-medium text-zinc-600 dark:text-zinc-300">Database ID</span>
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ $providerId }}</p>
                </div>
            </div>
        </flux:card>
    </div>

<div>
            ...
            <flux:card>
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">{{ $provider['class'] }}</p>
                    </div>
                ...
                @if ($provider['last_synced_at'])
                    <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Last synced: {{ $provider['last_synced_at'] }}</p>
                @endif
                ...
                <div class="mt-4">
                    <p class="text-xs font-semibold text-zinc-600 dark:text-zinc-300 uppercase tracking-wider">Capabilities</p>
                ...
                <div class="mt-4 pt-3 border-t border-zinc-200 dark:border-zinc-700 flex gap-2">
    ...
    @if (empty($providers))
        <flux:card>
            <p class="text-zinc-500 dark:text-zinc-400">No providers registered. Add knowledge sources to register providers.</p>
        </flux:card>
    @endif
</div>
